...
public class DaysFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        daysRecyclerView = daysView.findViewById(R.id.days_recycler_view);
        ...
        EventsAdapter.EventClickListener eventClickListener = new EventsAdapter.EventClickListener() {
            ...
            public void onItemClick(final ScheduleModel event, final View view1) {
                ...
                final ImageView deleteIcon = view.findViewById(R.id.event_delete_icon);
                ...
                deleteIcon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ImageView favIcon = view1.findViewById(R.id.event_fav_ico);
    ...
    public void getSearchDataFromRealm(String text, String categoryFilter, String venueFilter, String startTimeFilter, String endTimeFilter, boolean filter) {
        if (filter) {
            ...
            tempevents = realm.where(ScheduleModel.class).equalTo("day", (day + 1) + "").contains("eventName", text.trim(), Case.INSENSITIVE).contains("catName", categoryFilter.trim(), Case.INSENSITIVE).contains("venue", venueFilter.trim(), Case.INSENSITIVE).findAll().sort("startTime", Sort.ASCENDING, "eventName", Sort.ASCENDING);
            ...
            RealmResults<ScheduleModel> tempevents;
            Log.d("Day", (day + 1) + "");
            tempevents = realm.where(ScheduleModel.class).equalTo("day", (day + 1) + "").findAll().sort("startTime", Sort.ASCENDING, "eventName", Sort.ASCENDING);
